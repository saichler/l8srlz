...
// addInt64 serializes a 64-bit signed integer as 8 bytes using big-endian encoding.
...
// getInt64 deserializes 8 bytes as a 64-bit signed integer using big-endian decoding.
