...
// addUInt32 serializes a 32-bit unsigned integer as 4 bytes using big-endian encoding.
...
// getUInt32 deserializes 4 bytes as a 32-bit unsigned integer using big-endian decoding.
